...
const navItems = [
  { to: '/', label: '角色面板', icon: Sword, color: 'text-cyan-400', bg: 'bg-cyan-500/8', border: 'border-cyan-500/15' },
  { to: '/activities', label: '活动记录', icon: Activity, color: 'text-violet-400', bg: 'bg-violet-500/8', border: 'border-violet-500/15' },
  { to: '/achievements', label: '成就徽章', icon: Trophy, color: 'text-amber-400', bg: 'bg-amber-500/8', border: 'border-amber-500/15' },
  { to: '/quests', label: '任务', icon: Target, color: 'text-rose-400', bg: 'bg-rose-500/8', border: 'border-rose-500/15' },
  { to: '/outsource', label: '庶务外包', icon: Send, color: 'text-emerald-400', bg: 'bg-emerald-500/8', border: 'border-emerald-500/15' },
  { to: '/study', label: '期末复习', icon: GraduationCap, color: 'text-sky-400', bg: 'bg-sky-500/8', border: 'border-sky-500/15' },
  { to: '/stats', label: '数据统计', icon: BarChart3, color: 'text-orange-400', bg: 'bg-orange-500/8', border: 'border-orange-500/15' },
  { to: '/daily-reports', label: '日报', icon: Newspaper, color: 'text-pink-400', bg: 'bg-pink-500/8', border: 'border-pink-500/15' },
  { to: '/profile', label: '我的', icon: User, color: 'text-indigo-400', bg: 'bg-indigo-500/8', border: 'border-indigo-500/15' },
];
        ...
        <div className="grid grid-cols-3 gap-3">
          {navItems.map(item => (
            <button
              ...
              className={`flex flex-col items-center gap-2 p-4 rounded-2xl border transition-all duration-200 active:scale-95
